...
class DT_Scanner(LPF_Device):
	...
	def decode_pvs(self, port, data):
		# Mode 0
		# Won't scan these stationary, must be moving
		if len(data) == 2:
			first_bytes = int.from_bytes(data[0:], byteorder="little")

			if first_bytes == 1:
				# 35962pb04 : Sun Icon : Train speed pattern: 0,40,50,60,69
				...
				# Violent Yellow and Bright Light Yellow scan the same
				...
				return ('duplotrain_scantag','tab','bright green' )
